...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-1)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-11)
*   Check: `suicidal`
*   Severity: `High`
*   Confidence: `High`
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-14)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#exploit-scenario-15)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-18)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-24)
*   Check: `return-leave`
*   Severity: `High`
*   Confidence: `Medium`
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#exploit-scenario-33)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-35)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#recommendation-96)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-97)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#description-97)
State variables that are not updated following deployment should be declared immutable to save gas.

### Recommendation

[](https://github.com/crytic/slither/wiki/Detector-Documentation#recommendation-97)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#configuration-98)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#description-98)
The contract reads its own variable using `this`, adding overhead of an unnecessary STATICCALL.

### Exploit Scenario:

[](https://github.com/crytic/slither/wiki/Detector-Documentation#exploit-scenario-88)
...
[](https://github.com/crytic/slither/wiki/Detector-Documentation#recommendation-98)
