Title: Introduction to Smart Contracts — Solidity 0.8.31 documentation

URL Source: https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html

Published Time: Tue, 05 Aug 2025 10:49:32 GMT

Markdown Content:
A Simple Smart Contract[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#a-simple-smart-contract "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Storage Example[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#storage-example "Link to this heading")
...
### Subcurrency Example[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#subcurrency-example "Link to this heading")
...
Blockchain Basics[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#blockchain-basics "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------
...
### Transactions[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#transactions "Link to this heading")
...
### Blocks[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#blocks "Link to this heading")
...
The Ethereum Virtual Machine[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#index-6 "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------------------

### Overview[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#overview "Link to this heading")

The Ethereum Virtual Machine or EVM is the runtime environment for smart contracts in Ethereum. It is not only sandboxed but actually completely isolated, which means that code running inside the EVM has no access to network, filesystem or other processes. Smart contracts even have limited access to other smart contracts.

### Accounts[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#accounts "Link to this heading")
...
### Transactions[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#index-8 "Link to this heading")
...
### Gas[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#gas "Link to this heading")
...
### Storage, Transient Storage, Memory and the Stack[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#storage-transient-storage-memory-and-the-stack "Link to this heading")
...
### Calldata, Returndata and Code[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#calldata-returndata-and-code "Link to this heading")
...
### Instruction Set[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#instruction-set "Link to this heading")
...
### Message Calls[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#message-calls "Link to this heading")
...
### Delegatecall and Libraries[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#delegatecall-and-libraries "Link to this heading")
...
### Logs[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#logs "Link to this heading")
...
### Create[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#create "Link to this heading")
...
### Deactivate and Self-destruct[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#deactivate-and-self-destruct "Link to this heading")
...
### Precompiled Contracts[](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#precompiled-contracts "Link to this heading")
