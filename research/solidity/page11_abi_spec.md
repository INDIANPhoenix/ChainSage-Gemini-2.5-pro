Title: Contract ABI Specification — Solidity 0.8.31 documentation

URL Source: https://docs.soliditylang.org/en/latest/abi-spec.html

Published Time: Wed, 07 May 2025 17:06:12 GMT

Markdown Content:
Basic Design[](https://docs.soliditylang.org/en/latest/abi-spec.html#basic-design "Link to this heading")
----------------------------------------------------------------------------------------------------------
...
Function Selector[](https://docs.soliditylang.org/en/latest/abi-spec.html#function-selector "Link to this heading")
--------------------------------------------------------------------------------------------------------------------
...
The return type of a function is not part of this signature. In [Solidity’s function overloading](https://docs.soliditylang.org/en/latest/contracts.html#overload-function) return types are not considered. The reason is to keep function call resolution context-independent. The [JSON description of the ABI](https://docs.soliditylang.org/en/latest/abi-spec.html#abi-json) however contains both inputs and outputs.

Argument Encoding[](https://docs.soliditylang.org/en/latest/abi-spec.html#argument-encoding "Link to this heading")
--------------------------------------------------------------------------------------------------------------------
...
Types[](https://docs.soliditylang.org/en/latest/abi-spec.html#types "Link to this heading")
--------------------------------------------------------------------------------------------
...
### Mapping Solidity to ABI types[](https://docs.soliditylang.org/en/latest/abi-spec.html#mapping-solidity-to-abi-types "Link to this heading")
...
| Solidity | ABI |
| --- | --- |
| [address payable](https://docs.soliditylang.org/en/latest/types.html#address) | `address` |
| [contract](https://docs.soliditylang.org/en/latest/contracts.html#contracts) | `address` |
| [enum](https://docs.soliditylang.org/en/latest/types.html#enums) | `uint8` |
| [user defined value types](https://docs.soliditylang.org/en/latest/types.html#user-defined-value-types) | its underlying value type |
| [struct](https://docs.soliditylang.org/en/latest/types.html#structs) | `tuple` |
...
Design Criteria for the Encoding[](https://docs.soliditylang.org/en/latest/abi-spec.html#design-criteria-for-the-encoding "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------------------------
...
Formal Specification of the Encoding[](https://docs.soliditylang.org/en/latest/abi-spec.html#formal-specification-of-the-encoding "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
Function Selector and Argument Encoding[](https://docs.soliditylang.org/en/latest/abi-spec.html#function-selector-and-argument-encoding "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Examples[](https://docs.soliditylang.org/en/latest/abi-spec.html#examples "Link to this heading")
--------------------------------------------------------------------------------------------------
...
Use of Dynamic Types[](https://docs.soliditylang.org/en/latest/abi-spec.html#use-of-dynamic-types "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------
...
Events[](https://docs.soliditylang.org/en/latest/abi-spec.html#events "Link to this heading")
----------------------------------------------------------------------------------------------
...
JSON[](https://docs.soliditylang.org/en/latest/abi-spec.html#json "Link to this heading")
------------------------------------------------------------------------------------------
...
### Handling tuple types[](https://docs.soliditylang.org/en/latest/abi-spec.html#handling-tuple-types "Link to this heading")
...
Strict Encoding Mode[](https://docs.soliditylang.org/en/latest/abi-spec.html#strict-encoding-mode "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------
...
Non-standard Packed Mode[](https://docs.soliditylang.org/en/latest/abi-spec.html#non-standard-packed-mode "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------
...
Encoding of Indexed Event Parameters[](https://docs.soliditylang.org/en/latest/abi-spec.html#encoding-of-indexed-event-parameters "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------------------
