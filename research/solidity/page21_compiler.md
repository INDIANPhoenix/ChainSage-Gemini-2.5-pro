Title: Using the Compiler — Solidity 0.8.31 documentation
...
#### Error Types[](https://docs.soliditylang.org/en/latest/using-the-compiler.html#error-types "Link to this heading")
