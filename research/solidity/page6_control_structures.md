Title: Expressions and Control Structures — Solidity 0.8.31 documentation

URL Source: https://docs.soliditylang.org/en/latest/control-structures.html

Published Time: Wed, 07 May 2025 17:06:12 GMT

Markdown Content:
Control Structures[](https://docs.soliditylang.org/en/latest/control-structures.html#control-structures "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------
...
Function Calls[](https://docs.soliditylang.org/en/latest/control-structures.html#function-calls "Link to this heading")
------------------------------------------------------------------------------------------------------------------------

### Internal Function Calls[](https://docs.soliditylang.org/en/latest/control-structures.html#internal-function-calls "Link to this heading")

Functions of the current contract can be called directly (“internally”), also recursively, as seen in this nonsensical example:

[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### External Function Calls[](https://docs.soliditylang.org/en/latest/control-structures.html#external-function-calls "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
This check is not performed in case of [low-level calls](https://docs.soliditylang.org/en/latest/units-and-global-variables.html#address-related) which operate on addresses rather than contract instances.
...
Read about [precompiled contracts](https://docs.soliditylang.org/en/latest/introduction-to-smart-contracts.html#precompiledcontracts) and [low-level calls](https://docs.soliditylang.org/en/latest/units-and-global-variables.html#address-related) for more information.
...
### Function Calls with Named Parameters[](https://docs.soliditylang.org/en/latest/control-structures.html#function-calls-with-named-parameters "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### Omitted Names in Function Definitions[](https://docs.soliditylang.org/en/latest/control-structures.html#omitted-names-in-function-definitions "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
Creating Contracts via `new`[](https://docs.soliditylang.org/en/latest/control-structures.html#creating-contracts-via-new "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------------------------
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### Salted contract creations / create2[](https://docs.soliditylang.org/en/latest/control-structures.html#salted-contract-creations-create2 "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
Order of Evaluation of Expressions[](https://docs.soliditylang.org/en/latest/control-structures.html#order-of-evaluation-of-expressions "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Assignment[](https://docs.soliditylang.org/en/latest/control-structures.html#assignment "Link to this heading")
----------------------------------------------------------------------------------------------------------------

### Destructuring Assignments and Returning Multiple Values[](https://docs.soliditylang.org/en/latest/control-structures.html#destructuring-assignments-and-returning-multiple-values "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### Complications for Arrays and Structs[](https://docs.soliditylang.org/en/latest/control-structures.html#complications-for-arrays-and-structs "Link to this heading")

The semantics of assignments are more complicated for non-value types like arrays and structs, including `bytes` and `string`, see [Data location and assignment behavior](https://docs.soliditylang.org/en/latest/types.html#data-location-assignment) for details.
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
Scoping and Declarations[](https://docs.soliditylang.org/en/latest/control-structures.html#scoping-and-declarations "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------------------
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
Checked or Unchecked Arithmetic[](https://docs.soliditylang.org/en/latest/control-structures.html#checked-or-unchecked-arithmetic "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
Error handling: Assert, Require, Revert and Exceptions[](https://docs.soliditylang.org/en/latest/control-structures.html#error-handling-assert-require-revert-and-exceptions "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
3.   If you create a contract using the `new` keyword but the contract creation [does not finish properly](https://docs.soliditylang.org/en/latest/control-structures.html#creating-contracts).
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### `revert`[](https://docs.soliditylang.org/en/latest/control-structures.html#revert "Link to this heading")
...
[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
The provided string is [abi-encoded](https://docs.soliditylang.org/en/latest/abi-spec.html#abi) as if it were a call to a function `Error(string)`. In the above example, `revert("Not enough Ether provided.");` returns the following hexadecimal as error return data:

[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
...
### `try`/`catch`[](https://docs.soliditylang.org/en/latest/control-structures.html#try-catch "Link to this heading")

A failure in an external call can be caught using a try/catch statement, as follows:

[open in Remix](https://remix.ethereum.org/?#language=solidity&version=0.8.31&code=)
