Title: Types — Solidity 0.8.31 documentation

URL Source: https://docs.soliditylang.org/en/latest/types.html

Published Time: Tue, 05 Aug 2025 09:56:39 GMT

Markdown Content:
Solidity is a statically typed language, which means that the type of each variable (state and local) needs to be specified. Solidity provides several elementary types which can be combined to form complex types.

In addition, types can interact with each other in expressions containing operators. For a quick reference of the various operators, see [Order of Precedence of Operators](https://docs.soliditylang.org/en/latest/types.html#order).
...
Value Types[](https://docs.soliditylang.org/en/latest/types.html#value-types "Link to this heading")
-----------------------------------------------------------------------------------------------------
...
### Integers[](https://docs.soliditylang.org/en/latest/types.html#integers "Link to this heading")
...
#### Comparisons[](https://docs.soliditylang.org/en/latest/types.html#comparisons "Link to this heading")

The value of a comparison is the one obtained by comparing the integer value.

#### Bit operations[](https://docs.soliditylang.org/en/latest/types.html#bit-operations "Link to this heading")
...
#### Shifts[](https://docs.soliditylang.org/en/latest/types.html#shifts "Link to this heading")
...
#### Addition, Subtraction and Multiplication[](https://docs.soliditylang.org/en/latest/types.html#addition-subtraction-and-multiplication "Link to this heading")
...
#### Division[](https://docs.soliditylang.org/en/latest/types.html#division "Link to this heading")
...
Note that in contrast, division on [literals](https://docs.soliditylang.org/en/latest/types.html#rational-literals) results in fractional values of arbitrary precision.
...
#### Modulo[](https://docs.soliditylang.org/en/latest/types.html#modulo "Link to this heading")
...
#### Exponentiation[](https://docs.soliditylang.org/en/latest/types.html#exponentiation "Link to this heading")
...
### Fixed Point Numbers[](https://docs.soliditylang.org/en/latest/types.html#fixed-point-numbers "Link to this heading")
...
### Address[](https://docs.soliditylang.org/en/latest/types.html#address "Link to this heading")
...
You can use `address(bytes20(b))`, which results in `0x111122223333444455556666777788889999aAaa`, or you can use `address(uint160(uint256(b)))`, which results in `0x777788889999AaAAbBbbCcccddDdeeeEfFFfCcCc`.

Note

Mixed-case hexadecimal numbers conforming to [EIP-55](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-55.md) are automatically treated as literals of the `address` type. See [Address Literals](https://docs.soliditylang.org/en/latest/types.html#address-literals).

#### Members of Addresses[](https://docs.soliditylang.org/en/latest/types.html#members-of-addresses "Link to this heading")
...
### Contract Types[](https://docs.soliditylang.org/en/latest/types.html#contract-types "Link to this heading")
...
Explicit conversion to and from the `address payable` type is only possible if the contract type has a receive or payable fallback function. The conversion is still performed using `address(x)`. If the contract type does not have a receive or payable fallback function, the conversion to `address payable` can be done using `payable(address(x))`. You can find more information in the section about the [address type](https://docs.soliditylang.org/en/latest/types.html#address).
...
### Fixed-size byte arrays[](https://docs.soliditylang.org/en/latest/types.html#fixed-size-byte-arrays "Link to this heading")
...
### Address Literals[](https://docs.soliditylang.org/en/latest/types.html#address-literals "Link to this heading")
...
### Rational and Integer Literals[](https://docs.soliditylang.org/en/latest/types.html#rational-and-integer-literals "Link to this heading")
...
### String Literals and Types[](https://docs.soliditylang.org/en/latest/types.html#string-literals-and-types "Link to this heading")
...
### Unicode Literals[](https://docs.soliditylang.org/en/latest/types.html#unicode-literals "Link to this heading")
...
### Hexadecimal Literals[](https://docs.soliditylang.org/en/latest/types.html#hexadecimal-literals "Link to this heading")
...
Hexadecimal literals in some ways behave like [string literals](https://docs.soliditylang.org/en/latest/types.html#string-literals) but are not implicitly convertible to the `string` type.

### Enums[](https://docs.soliditylang.org/en/latest/types.html#enums "Link to this heading")
...
### User-defined Value Types[](https://docs.soliditylang.org/en/latest/types.html#user-defined-value-types "Link to this heading")
...
### Function Types[](https://docs.soliditylang.org/en/latest/types.html#function-types "Link to this heading")
...
#### Declaration syntax[](https://docs.soliditylang.org/en/latest/types.html#declaration-syntax "Link to this heading")
...
#### Conversions[](https://docs.soliditylang.org/en/latest/types.html#conversions "Link to this heading")
...
#### Members[](https://docs.soliditylang.org/en/latest/types.html#members "Link to this heading")
...
#### Value stability across contract updates[](https://docs.soliditylang.org/en/latest/types.html#value-stability-across-contract-updates "Link to this heading")
...
#### Examples[](https://docs.soliditylang.org/en/latest/types.html#examples "Link to this heading")
...
Reference Types[](https://docs.soliditylang.org/en/latest/types.html#reference-types "Link to this heading")
-------------------------------------------------------------------------------------------------------------
...
### Data location[](https://docs.soliditylang.org/en/latest/types.html#data-location "Link to this heading")
...
#### Data location and assignment behavior[](https://docs.soliditylang.org/en/latest/types.html#data-location-and-assignment-behavior "Link to this heading")
...
### Arrays[](https://docs.soliditylang.org/en/latest/types.html#arrays "Link to this heading")
...
#### `bytes` and `string` as Arrays[](https://docs.soliditylang.org/en/latest/types.html#bytes-and-string-as-arrays "Link to this heading")
...
#### The functions `bytes.concat` and `string.concat`[](https://docs.soliditylang.org/en/latest/types.html#the-functions-bytes-concat-and-string-concat "Link to this heading")
...
#### Allocating Memory Arrays[](https://docs.soliditylang.org/en/latest/types.html#allocating-memory-arrays "Link to this heading")
...
#### Array Literals[](https://docs.soliditylang.org/en/latest/types.html#array-literals "Link to this heading")
...
#### Array Members[](https://docs.soliditylang.org/en/latest/types.html#array-members "Link to this heading")
...
**pop()**:
Dynamic storage arrays and `bytes` (not `string`) have a member function called `pop()` that you can use to remove an element from the end of the array. This also implicitly calls [delete](https://docs.soliditylang.org/en/latest/types.html#delete) on the removed element. The function returns nothing.

Note

Increasing the length of a storage array by calling `push()` has constant gas costs because storage is zero-initialised, while decreasing the length by calling `pop()` has a cost that depends on the “size” of the element being removed. If that element is an array, it can be very costly, because it includes explicitly clearing the removed elements similar to calling [delete](https://docs.soliditylang.org/en/latest/types.html#delete) on them.
...
#### Dangling References to Storage Array Elements[](https://docs.soliditylang.org/en/latest/types.html#dangling-references-to-storage-array-elements "Link to this heading")
...
### Array Slices[](https://docs.soliditylang.org/en/latest/types.html#array-slices "Link to this heading")
...
### Structs[](https://docs.soliditylang.org/en/latest/types.html#structs "Link to this heading")
...
Mapping Types[](https://docs.soliditylang.org/en/latest/types.html#mapping-types "Link to this heading")
---------------------------------------------------------------------------------------------------------

Mapping types use the syntax `mapping(KeyType KeyName? => ValueType ValueName?)` and variables of mapping type are declared using the syntax 
```
mapping(KeyType KeyName? => ValueType ValueName?)
VariableName
```
. The `KeyType` can be any built-in value type, `bytes`, `string`, or any contract or enum type. Other user-defined or complex types, such as mappings, structs or array types are not allowed. `ValueType` can be any type, including mappings, arrays and structs. `KeyName` and `ValueName` are optional (so `mapping(KeyType => ValueType)` works as well) and can be any valid identifier that is not a type.
...
### Iterable Mappings[](https://docs.soliditylang.org/en/latest/types.html#iterable-mappings "Link to this heading")
...
Operators[](https://docs.soliditylang.org/en/latest/types.html#operators "Link to this heading")
-------------------------------------------------------------------------------------------------
...
### Ternary Operator[](https://docs.soliditylang.org/en/latest/types.html#ternary-operator "Link to this heading")
...
### Order of Precedence of Operators[](https://docs.soliditylang.org/en/latest/types.html#order-of-precedence-of-operators "Link to this heading")
...
Conversions between Elementary Types[](https://docs.soliditylang.org/en/latest/types.html#conversions-between-elementary-types "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------

### Implicit Conversions[](https://docs.soliditylang.org/en/latest/types.html#implicit-conversions "Link to this heading")
...
### Explicit Conversions[](https://docs.soliditylang.org/en/latest/types.html#explicit-conversions "Link to this heading")
...
Conversions between Literals and Elementary Types[](https://docs.soliditylang.org/en/latest/types.html#conversions-between-literals-and-elementary-types "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

### Integer Types[](https://docs.soliditylang.org/en/latest/types.html#integer-types "Link to this heading")
...
### Fixed-Size Byte Arrays[](https://docs.soliditylang.org/en/latest/types.html#index-34 "Link to this heading")
...
### Addresses[](https://docs.soliditylang.org/en/latest/types.html#addresses "Link to this heading")

As described in [Address Literals](https://docs.soliditylang.org/en/latest/types.html#address-literals), hex literals of the correct size that pass the checksum test are of `address` type. No other literals can be implicitly converted to the `address` type.
