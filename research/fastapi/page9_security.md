...
URL Source: https://fastapi.tiangolo.com/tutorial/security/
...
[](https://fastapi.tiangolo.com/tutorial/security/?q= "Share")
...
Security[¶](https://fastapi.tiangolo.com/tutorial/security/#security "Permanent link")
======================================================================================
...
In a hurry?[¶](https://fastapi.tiangolo.com/tutorial/security/#in-a-hurry "Permanent link")
-------------------------------------------------------------------------------------------
...
OAuth2[¶](https://fastapi.tiangolo.com/tutorial/security/#oauth2 "Permanent link")
----------------------------------------------------------------------------------
...
OpenID Connect[¶](https://fastapi.tiangolo.com/tutorial/security/#openid-connect "Permanent link")
--------------------------------------------------------------------------------------------------
...
### OpenID (not "OpenID Connect")[¶](https://fastapi.tiangolo.com/tutorial/security/#openid-not-openid-connect "Permanent link")
...
**FastAPI** utilities[¶](https://fastapi.tiangolo.com/tutorial/security/#fastapi-utilities "Permanent link")
------------------------------------------------------------------------------------------------------------
...
And you will also see how it gets automatically integrated into the interactive documentation system.
 ...
 Back to top [Previous Dependencies with yield](https://fastapi.tiangolo.com/tutorial/dependencies/dependencies-with-yield/)[Next Security - First Steps](https://fastapi.tiangolo.com/tutorial/security/first-steps/)
