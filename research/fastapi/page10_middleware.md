...
URL Source: https://fastapi.tiangolo.com/tutorial/middleware/
...
[Skip to content](https://fastapi.tiangolo.com/tutorial/middleware/#middleware)
...
[](https://fastapi.tiangolo.com/tutorial/middleware/?q= "Share")
...
*   - [x] [Learn](https://fastapi.tiangolo.com/learn/)  Learn  
    ...
    *   - [x] [Tutorial - User Guide](https://fastapi.tiangolo.com/tutorial/)  Tutorial - User Guide  
        ...
        *   - [x]  Middleware  [Middleware](https://fastapi.tiangolo.com/tutorial/middleware/) Table of contents  
            *   [Create a middleware](https://fastapi.tiangolo.com/tutorial/middleware/#create-a-middleware)
                *   [Before and after the `response`](https://fastapi.tiangolo.com/tutorial/middleware/#before-and-after-the-response)

            *   [Multiple middleware execution order](https://fastapi.tiangolo.com/tutorial/middleware/#multiple-middleware-execution-order)
            *   [Other middlewares](https://fastapi.tiangolo.com/tutorial/middleware/#other-middlewares)
...
You will read about how to handle CORS with a middleware in the next section.
 ...
 Back to top [Previous OAuth2 with Password (and hashing), Bearer with JWT tokens](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/)[Next CORS (Cross-Origin Resource Sharing)](https://fastapi.tiangolo.com/tutorial/cors/)
