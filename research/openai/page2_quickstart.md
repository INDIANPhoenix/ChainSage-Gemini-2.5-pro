...
URL Source: https://platform.openai.com/docs/quickstart
...
[Configure your development environment Install and configure an official OpenAI SDK to run the code above.](https://platform.openai.com/docs/libraries)[Responses starter app Start building with the Responses API.](https://github.com/openai/openai-responses-starter-app)[Text generation and prompting Learn more about prompting, message roles, and building conversational apps.](https://platform.openai.com/docs/guides/text)
...
[Image inputs guide Learn to use image inputs to the model and extract meaning from images.](https://platform.openai.com/docs/guides/images)[File inputs guide Learn to use file inputs to the model and extract meaning from documents.](https://platform.openai.com/docs/guides/pdf-files)
...
[Use built-in tools Learn about powerful built-in tools like web search and file search.](https://platform.openai.com/docs/guides/tools)[Function calling guide Learn to enable the model to call your own custom code.](https://platform.openai.com/docs/guides/function-calling)
...
[Use streaming events Use server-sent events to stream model responses to users fast.](https://platform.openai.com/docs/guides/streaming-responses)[Get started with the Realtime API Use WebRTC or WebSockets for super fast speech-to-speech AI apps.](https://platform.openai.com/docs/guides/realtime)
Build agents
------------
...
[Build agents that can take action Learn how to use the OpenAI platform to build powerful, capable AI agents.](https://platform.openai.com/docs/guides/agents)

*   [Generate text](https://platform.openai.com/docs/quickstart#page-top)
*   [Analyze images and files](https://platform.openai.com/docs/quickstart#analyze-images-and-files)
*   [Use powerful tools](https://platform.openai.com/docs/quickstart#extend-the-model-with-tools)
*   [Respond to users fast](https://platform.openai.com/docs/quickstart#stream-responses-and-build-realtime-apps)
*   [Build agents](https://platform.openai.com/docs/quickstart#build-agents)
