...
URL Source: https://nextjs.org/docs/app/building-your-application/data-fetching/patterns

Markdown Content:
Getting Started: Fetching Data | Next.js

===============
[Skip to content](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#geist-skip-nav)
...
*   [Fetching data](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#fetching-data)
*   [Server Components](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#server-components)
*   [With the fetch API](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-the-fetch-api)
*   [With an ORM or database](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-an-orm-or-database)
*   [Client Components](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#client-components)
*   [Streaming data with the use hook](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming-data-with-the-use-hook)
*   [Community libraries](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#community-libraries)
*   [Deduplicate requests and cache data](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#deduplicate-requests-and-cache-data)
*   [Streaming](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming)
*   [With loading.js](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-loadingjs)
*   [With <Suspense>](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-suspense)
*   [Creating meaningful loading states](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#creating-meaningful-loading-states)
*   [Examples](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#examples)
...
*   [API Reference](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#api-reference)
...
This page will walk you through how you can fetch data in [Server and Client Components](https://nextjs.org/docs/app/getting-started/server-and-client-components), and how to [stream](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming) components that depend on data.
...
1.   The [`fetch` API](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-the-fetch-api)
2.   An [ORM or database](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-an-orm-or-database)
...
You can use React's [`use` hook](https://react.dev/reference/react/use) to [stream](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming) data from the server to client. Start by fetching data in your Server component, and pass the promise to your Client Component as prop:
...
In the example above, the `<Posts>` component is wrapped in a [`<Suspense>` boundary](https://react.dev/reference/react/Suspense). This means the fallback will be shown while the promise is being resolved. Learn more about [streaming](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming).
...
1.   Wrapping a page with a [`loading.js` file](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-loadingjs)
2.   Wrapping a component with [`<Suspense>`](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#with-suspense)
...
On navigation, the user will immediately see the layout and a [loading state](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#creating-meaningful-loading-states) while the page is being rendered. The new content will then be automatically swapped in once rendering is complete.
...
To improve the user experience, you should use [React `<Suspense>`](https://nextjs.org/docs/app/getting-started/linking-and-navigating#streaming) to show a `fallback` while data is being fetch. This will enable [streaming](https://nextjs.org/docs/app/building-your-application/data-fetching/patterns#streaming) and prevent the whole route from being blocked by the sequential data requests.
